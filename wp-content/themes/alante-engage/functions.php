...
function alante_thinkup_child_frontscripts() {
	...
	wp_enqueue_style( 'alante-thinkup-style-engage', get_stylesheet_directory_uri() . '/style.css', array( 'alante-thinkup-style' ), wp_get_theme()->get('Version') );
}
...
function alante_thinkup_updateoption_child_color() {
	...
	$name_child_color   = $name_theme_lower . '_thinkup_child_color_engage';
